...
spa.shell = (function () {
  ...
  // When the account element is tapped and the user is 
  // anonymouse then prompt for user name and invoke method
  // spa.model.people.login( <user_name> ). If the user
  // is already logged in then invoke method 
  ...
  // Updates the user area in the top-right corner by
  // replacing the "Please Sign-in" text with the user name.
  // The user name is provided by the login_user object distributed
  // by the spa-login event.
  ...
  // Reverts the user area test back to "Please Sign-in"
  ...
  initModule = function ( $container ) {
    ...
    // configure the avatar feature module
    ...
    // Have the $container jQuery collection subscribe the
    // onLogin and onLogout event handlers to events spa-login
    // and spa-logout respectively.
    $.gevent.subscribe( $container, 'spa-login', onLogin );
    $.gevent.subscribe( $container, 'spa-logout', onLogout );

    // Initialize the user area text and bind a touch/mouse click
