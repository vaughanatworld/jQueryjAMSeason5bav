...
spa.avtr = (function () {
  ...
  // Reads the css values from the parameter $target avatar and
  // invokes the model.chat.update_avatar method.
  ...
  // Event handler triggered when user clicks or taps 
  // the navigation area. Uses event delegation. Only reacts
  // if the element beneath the tap target is an avatar. 
  ...
  // Event handlder trigged when the user starts a dragging 
  // motion in the navigation area.
  ...
  // Event handler triggered when the user is in 
  // the process of dragging an avatar. Executed
  // frequently so calcs are kept to a minimum.
  ...
  // event handler triggered when user releases an
  // avatar after a drag. Handler returns the dragged
  // avatar to its original color. Invokes the updateAvatar
  // method to read avatar details and invoke the 
  // model.chat.update_avatar( <update_map> ) method.
  ...
  // Event handler invoked when the Model publishes
  // an  spa-setchatee event. Sets the ouline of the 
  // chatee avatar to green.
  onSetchatee = function( event, arg_map ) {
    ...
    // Use this to highlight avatar of user in nav
    // area. See new_chatee.name, old_chatee.name, etc.
  ...
  // event handler invoked when the Model publishes an
  // spa-listchange event. Redraws avatars.
  ...
  // event handler invoked when Model publishes 
  // an spa-logout event. Removes all avatars.
  onLogout = function() {
  ...
  //              values not expected to change during a user session.
  // Action     : The internal configuration data structure
  //              (configMap) is updated with provided arguments.
  // Returns    : none
  ...
  // Purpose    : Directs the module to begin offering its features
